...
import assest from "../assets/img/hero-img.png";
import image from "../assets/img/team/team-4.jpg";
...
import img7 from "../assets/img/skills.png";
              ...
              <div className="col-lg-5 d-flex align-items-stretch">
                <div className="info">
                  <div className="address">
                    ...
                    <h4>Location:</h4>
                    <p>Gwalior(M.P) Murlinagar near silveroak</p>
                  </div>

                  <div className="email">
                    <i className="bi bi-envelope"></i>
                    <h4>Email:</h4>
                    <p>cognicodeitsolution@gmail.com</p>
                  </div>
